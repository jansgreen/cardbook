...
class _DashboardContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final username = firstName?.isNotEmpty == true
        ? firstName!
        : (user['username'] as String? ?? 'Cardbook');
      ...
      children: [
        ...
        GlassCard(
          ...
          child: Column(
            ...
            children: [
              const SectionHeader(
                  title: 'Resumen rapido', actionLabel: 'Ver todo'),
              ...
              GridView.count(
                ...
                children: [
                  ...
                  MetricCard(
                      label: 'Alianzas',
                      value: '${summary['alliances'] ?? 0}',
                      icon: Icons.handshake_rounded,
                      accent: AppColors.green),
                  MetricCard(
                      label: 'Book',
                      value: '${summary['book_items'] ?? 0}',
        ...
        GlassCard(
          child: Column(
            ...
            children: [
              const SectionHeader(
                  title: 'Empresas activas', actionLabel: 'Ver todas'),
              const SizedBox(height: 12),
        ...
        GlassCard(
          child: Column(
            ...
            children: [
              const SectionHeader(
                  title: 'Publicaciones recientes', actionLabel: 'Ver todas'),
              const SizedBox(height: 12),
              if (posts.isEmpty)
        ...
        GlassCard(
          child: Column(
            ...
            children: [
              const SectionHeader(
                  title: 'Empresas sugeridas', actionLabel: 'Explorar'),
              const SizedBox(height: 12),
              if (suggested.isEmpty)
                const _EmptyState(
                    message: 'Cuando haya afinidad, veras sugerencias aqui.')
              else
...
class _WelcomeHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GlassCard(
      ...
      borderColor: AppColors.blue.withValues(alpha: .32),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const StatusBadge(
              label: 'Cardbook movil',
