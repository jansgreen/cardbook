...
from .views import (
    ...
    DashboardHomeView,
    DashboardMembershipPlanCreateView,
    DashboardMembershipPlanDeleteView,
    DashboardMembershipPlanUpdateView,
    DashboardMembershipPlansView,
    DashboardPlanView,
...
urlpatterns = [
    ...
    path("billing/plans/", DashboardMembershipPlansView.as_view(), name="dashboard-membership-plans"),
    path("billing/plans/new/", DashboardMembershipPlanCreateView.as_view(), name="dashboard-membership-plan-create"),
    path("billing/plans/<int:pk>/edit/", DashboardMembershipPlanUpdateView.as_view(), name="dashboard-membership-plan-update"),
    path("billing/plans/<int:pk>/delete/", DashboardMembershipPlanDeleteView.as_view(), name="dashboard-membership-plan-delete"),
