...
class WhiteCardJob(models.Model):
    ...
    physical_card_front_image = models.ImageField(upload_to="jobcards/scans/", blank=True, null=True)
    physical_card_back_image = models.ImageField(upload_to="jobcards/scans/", blank=True, null=True)
